...
Zoals hierboven staat, bevat dit tabel zowel variabelen van de classes Intergers, Doubles en Characters. Echter is de class van teamID en lgID nog incorrect, dit zouden een factoren moeten zijn. Daarnaast zijn ook enkele Interger kolommen opgevat als Characters. Dit betekend dat dit in meerdere tabellen een probleem kan zijn. Kijkend naar de vragen in de opdrachtbeschrijving hebben we besloten om vanaf nu gebruik te maken van de volgende tabellen:
\begin{itemize}
\item Pitching
\item Batting
\item Fielding
...
db_Pitching$IBB = as.interger(db_Pitching$IBB)
db_Pitching$WP = as.interger(db_Pitching$WP)
db_Pitching$HBP = as.interger(db_Pitching$HBP)
db_Pitching$BFP = as.interger(db_Pitching$BFP)
db_Pitching$GF = as.interger(db_Pitching$GF)
db_Pitching$SH = as.interger(db_Pitching$SH)
db_Pitching$SF = as.interger(db_Pitching$SF)
...
db_Batting$IBB = as.interger(db_Batting$IBB)
db_Batting$HBP = as.interger(db_Batting$HBP)
db_Batting$SH = as.interger(db_Batting$SH)
db_Batting$SF = as.interger(db_Batting$SF)
...
db_Fielding$GS = as.interger(db_Fielding$GS)
db_Fielding$InnOuts = as.interger(db_Fielding$InnOuts)
db_Fielding$PB = as.interger(db_Fielding$PB)
db_Fielding$WP = as.interger(db_Fielding$WP)
db_Fielding$SB = as.interger(db_Fielding$SB)
db_Fielding$CS = as.interger(db_Fielding$CS)
db_Fielding$ZR = as.interger(db_Fielding$ZR)
...
db_Teams$Ghome = as.interger(db_Teams$Ghome)
...
db_Teams$CS = as.interger(db_Teams$CS)
db_Teams$HBP = as.interger(db_Teams$HBP)
db_Teams$SF = as.interger(db_Teams$SF)
db_Teams$DP = as.interger(db_Teams$DP)
db_Teams$attendance = as.interger(db_Teams$attendance)
...
Vervolgens kijken wij naar de ontbrekende data met behulp van een missing map.
```{r Create missingmap from Pitching}
missmap(db_Pitching, col=c("wheat","darkred"), legend=FALSE)
```

...
Na het opstellen van het ERD en het DWH kunnen we beginnen aan het ETL proces. Des te beter dit proces wordt uitgevoerd, des te makkelijker de rest van het data Analyst proces wordt. De data is opgeslagen in een lokale MySQL Database.  

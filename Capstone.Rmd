...
De opdracht meende dat sommige tabellen variabelen bevatte met het verkeerde type. Om dit te verifieren voeren wij een 0e functie uit op het Pitching tabel.

```{r glimpsing}
glimpse(db_Pitching)
```

Dat is dus echter incorrect. Zoals hierboven staat, bevat dit tabel zowel variabelen van de classes Intergers, Doubles en Characters. Echter is de class van teamID en lgID nog incorrect, dit zou een factor moeten zijn. Dit betekend dat dit in meerdere tabellen een probleem kan zijn. Kijkend naar de vragen in de opdrachtbeschrijving hebben we besloten om vanaf nu gebruik te maken van de volgende tabellen:
\begin{itemize}
\item Pitching
\item Batting
\item Fielding

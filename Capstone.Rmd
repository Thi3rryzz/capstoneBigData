...
missmap(db_Batting, col=c("black", "grey"), y.labels=NULL, y.at = NULL,legend=FALSE, main="Missingness Map of Batting")

missmap(db_Fielding, col=c("black", "grey"), y.labels=NULL, y.at = NULL,legend=FALSE, main="Missingness Map of Fielding")

missmap(db_Teams, col=c("black", "grey"), y.labels=NULL, y.at = NULL,legend=FALSE, main="Missingness Map of Teams")

missmap(db_Salaries, col=c("black", "grey"), y.labels=NULL, y.at = NULL,legend=FALSE, main="Missingness Map of Salaries")
...
db_Appearancesteam$yearID = strptime(db_Appearancesteam$yearID, "%Y")
db_Appearancesteam$yearID = as.character(db_Appearancesteam$yearID)

ggplot()+
  geom_line(data=db_Appearances, aes(yearID, G_all, color=as.factor(Accelerometer)))
